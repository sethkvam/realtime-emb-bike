...
main.o: main.c lpc1114.h main.h
	gcc-arm -c -g main.c
...
adservo: libos.a lpc1114.ld main.o 
	ld-arm -o adservo -T lpc1114.ld libos.a main.o  
f_derail: front_derailer.o libos.a
	ld-arm -o f_derail -T lpc1114.ld libos.a front_derailer.o


main: libos.a front_derailer.o ssd1306.o main.o stepper.o
	ld-arm -o main -T lpc1114.ld libos.a front_derailer.o ssd1306.o main.o stepper.o
run: main
...
clean: 
	rm reset.o vector.o ssd1306.o stepper.o front_derailer.o libos.a adservo lcd stepper f_derail main.o main
	clear
